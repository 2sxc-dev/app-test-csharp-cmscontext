...
public class ParametersController : Custom.Hybrid.Api12
{

    [HttpGet]				// [HttpGet] says we're listening to GET requests
    public string ReturnGiven()
    {
        return CmsContext.Page.Parameters.ToString(); //"Hello from the controller with ValidateAntiForgeryToken in /api";
    }
